...
@Component
public class CareerService implements Career_Repo{ //implements the career service class
    ...
    static{
        ...
        Career softwareEngineer = new Career(1,"Software Engineer", "Build App's,", 1000.00);
